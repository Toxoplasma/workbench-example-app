...
ScalaJS.c.Lexample_ScalaJSExample$.prototype.main__Lorg_scalajs_dom_raw_HTMLCanvasElement__V = (function(canvas) {
  ...
  g.genMap__scm_Set();
  var zedSpawner = new ScalaJS.c.Lobjects_ZombieSpawner().init___I__I__I(20, 20, 20);
...
ScalaJS.c.Lexample_ScalaJSExample$.prototype.example$ScalaJSExample$$run$1__scm_Set__Lorg_scalajs_dom_raw_CanvasRenderingContext2D__Lobjects_Game__V = (function(keysDown$1, ctx$1, g$1) {
  if ((g$1.player$1.hp$2 <= 0)) {
    ...
    var s = new ScalaJS.c.s_StringContext().init___sc_Seq(new ScalaJS.c.sjs_js_WrappedArray().init___sjs_js_Array(["rgb(200, 0, 0)"])).s__sc_Seq__T(ScalaJS.m.sci_Nil$());
    ctx$1["fillStyle"] = s;
    var jsx$1 = ScalaJS.m.Lobjects_GVs$().GAMEX$1;
    var x = (ScalaJS.imul(((ScalaJS.m.Lobjects_GVs$().FULLX$1 - ScalaJS.m.Lobjects_GVs$().GAMEX$1) | 0), g$1.player$1.hp$2) / g$1.player$1.maxHp$2);
    ctx$1["fillRect"](jsx$1, 0.0, ((x > 0.0) ? x : 0.0), 80.0);
...
ScalaJS.c.Lobjects_Game.prototype.genMap__scm_Set = (function() {
  var topWall = new ScalaJS.c.Lobjects_Wall().init___I__I__I__I(0, 0, ScalaJS.m.Lobjects_GVs$().GAMEX$1, 5);
  ...
  var botWall = new ScalaJS.c.Lobjects_Wall().init___I__I__I__I(0, (((-5) + ScalaJS.m.Lobjects_GVs$().GAMEY$1) | 0), ScalaJS.m.Lobjects_GVs$().GAMEX$1, 5);
  var this$1 = this.objs$1;
  this$1.$$plus$eq__O__scm_HashSet(topWall);
  var this$2 = this.objs$1;
  this$2.$$plus$eq__O__scm_HashSet(leftWall);
  var this$3 = this.objs$1;
  this$3.$$plus$eq__O__scm_HashSet(rightWall);
  var this$4 = this.objs$1;
  return this$4.$$plus$eq__O__scm_HashSet(botWall)
});
...
ScalaJS.c.Lobjects_Actor.prototype.canMoveTo__I__I__Lobjects_Game__Z = (function(newX, newY, g) {
  ...
  try {
    g.objs$1.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, newX$1, newY$1, nonLocalReturnKey1$1) {
      return (function(o$2) {
...
ScalaJS.c.Lobjects_Human.prototype.aiMove__Lobjects_Game__V = (function(g) {
  ...
  if ((this.timeToNextShot$3 === 0)) {
    ...
    g.acts$1.foreach__F1__V(new ScalaJS.c.sjsr_AnonFunction1().init___sjs_js_Function1((function(arg$outer, closestAct$1, distance$1) {
      return (function(a$2) {
        var a = ScalaJS.as.Lobjects_Actor(a$2);
        if (((a.faction$2 !== "NA") && (a.faction$2 !== arg$outer.faction$2))) {
    ...
    if ((distance.elem$1 <= 200)) {
      ...
      g.linesToDraw$1.$$plus$eq__O__scm_Buffer(new ScalaJS.c.Lobjects_SimpleLine().init___T2__T2__T(new ScalaJS.c.s_Tuple2$mcII$sp().init___I__I(this.locX$1, this.locY$1), new ScalaJS.c.s_Tuple2$mcII$sp().init___I__I(ScalaJS.as.Lobjects_Actor(closestAct.elem$1).locX$1, ScalaJS.as.Lobjects_Actor(closestAct.elem$1).locY$1), "black"))
    }
  } else {
...
ScalaJS.c.Lobjects_Zombie.prototype.aiMove__Lobjects_Game__V = (function(g) {
  ...
  this.moveLoc__I__I__Lobjects_Game__Z(dx, dy, g);
  if (this.target$3.collides__I__I__I__I__Z(((this.locX$1 + dx) | 0), ((this.locY$1 + dy) | 0), this.sizeX$1, this.sizeY$1)) {
